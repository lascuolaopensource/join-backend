...
import models.daos.slick.SlickPasswordInfoDAO
...
class SilhouetteModule extends AbstractModule with ScalaModule {
  ...
  /**
    * Provides the signer for the OAuth2 state provider.
    *
    * @param configuration The Play configuration.
    * @return The signer for the OAuth2 state provider.
    */
  @Provides @Named("oauth2-state-signer")
  def provideOAuth2StageSigner(configuration: Configuration): Signer = {
    val config = configuration.underlying.as[JcaSignerSettings]("silhouette.oauth2StateProvider.signer")
